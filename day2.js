...
// // // fibonic series.
// // // 0+1+2+3+5+8+13+21.....in fb series before num add compalsary.
// // let a = 0;
// // let b = 1;
// // for (let i = 0; i <= 15; i++) {
// //     let temp = a + b;
...
//         dacument.write('*')  // Move to the next line after each row

//         // Use process.stdout.write instead of console.log
//     }
//     // console.log();
//     dacumentt.write("<br>")  // Move to the next line after each row
// }

// let arr = [1, 2, 3, 3, 4];
// let repeatedElements = arr.filter((element, index) => arr.indexOf(element) !== index);

// console.log(repeatedElements);


const ary = [10, 23, 66, 44];
ary[10] = 20;
console.log(ary);
console.log(typeof (ary[4]));
